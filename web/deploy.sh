...
cp node_modules/jasmine-core/lib/jasmine-core/boot0.js $TARGETFOLDER/$WEBFOLDERNAME
cp node_modules/jasmine-core/lib/jasmine-core/boot1.js $TARGETFOLDER/$WEBFOLDERNAME
